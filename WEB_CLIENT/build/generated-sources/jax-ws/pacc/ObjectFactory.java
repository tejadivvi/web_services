...
public class ObjectFactory {
    ...
    private final static QName _Mul_QNAME = new QName("http://cal/", "Mul");
    private final static QName _Add_QNAME = new QName("http://cal/", "Add");
    private final static QName _Div_QNAME = new QName("http://cal/", "Div");
    private final static QName _Sub_QNAME = new QName("http://cal/", "Sub");
    private final static QName _AddResponse_QNAME = new QName("http://cal/", "AddResponse");
    private final static QName _MulResponse_QNAME = new QName("http://cal/", "MulResponse");
    private final static QName _DivResponse_QNAME = new QName("http://cal/", "DivResponse");
    private final static QName _SubResponse_QNAME = new QName("http://cal/", "SubResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pacc
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "Mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "Add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "Div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "Sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "AddResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "MulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "DivResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cal/", name = "SubResponse")
