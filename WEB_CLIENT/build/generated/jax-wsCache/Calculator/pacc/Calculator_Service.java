 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://cal/", wsdlLocation = "http://localhost:8080/Calculator/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://cal/", "Calculator");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://cal/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cal/", "CalculatorPort"), Calculator.class, features);
    }
